...
const missions = [
    { 
        ...
        description: "설문대할망의 신화적 키워드 3가지 (예: 한라, 오백장군, 섬)를 찾아 입력하여 '창조의 씨앗'을 획득합니다.",
        introDescription: "첫 번째 탐험의 목표는 '창조의 씨앗'을 찾는 것입니다. 전시 관람 중 설문대 신화와 관련된 신화적 키워드 3가지를 찾아 지혜를 증명해야 합니다.", 
        quiz: "전시 관람 중 설문대 신화와 관련된 **신화적 키워드 3가지**를 입력해주세요. (쉼표로 구분)",
    ...
    { 
        ...
        description: "두 단계의 힌트를 얻은 후, 하늘연못에서 최종적으로 사진을 찍어 '수호의 조각'을 획득합니다. (하늘연못 포토스팟)",
        introDescription: "제주돌문화공원에서 '수호의 조각'을 찾기 위해서는 **①돌문화 공원 산책**과 **②소원의 돌탑 쌓기**를 통해 하늘연못에 대한 힌트를 얻어야 합니다.",
        quiz: "제주돌문화공원 탐험의 첫 번째 단계인 **'돌문화 공원 산책'을 완료**하셨나요?", // M2-1
        answerType: 'hint-1', // M2-1 힌트 획득 플로우 시작
        hint2: "산책 후 돌탑을 쌓을 장소(hint)를 찾으셨나요? 두 번째 단계인 **'소원의 돌탑 쌓기'를 완료**하세요.", // M2-2
    ...
    { 
        ...
        quiz: "4.3 구연동화와 희생자를 위한 바람개비 바치기를 완료하셨습니다. **느낀 감정**을 자유롭게 작성해주세요.",
